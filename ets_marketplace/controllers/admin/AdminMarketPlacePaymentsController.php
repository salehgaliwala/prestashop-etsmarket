...
if (!defined('_PS_VERSION_'))
    	exit;
class AdminMarketPlacePaymentsController extends ModuleAdminController
{
    public function __construct()
    {
       parent::__construct();
       $this->_conf[7] = $this->l('The logo was successfully deleted.');
    ...
    public function renderList()
    {
        ...
        $this->context->smarty->assign(
            array(
                'ets_mp_body_html'=> Ets_mp_paymentmethod::getInstance()->_renderPayments(),
            )
        );
        $html ='';
